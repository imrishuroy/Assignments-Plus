      ...
      body: SingleChildScrollView(
        child: Padding(
          ...
          child: Column(
            children: [
              Text(
                'Privacy Policy Last updated July 15',
                style: TextStyle(
                  fontSize: 20.0,
